...
public class SimpleBankingApp {
	...
	public static void printAllAccounts() {
		...
		System.out.println(String.format("%-10s| %-30s| %-10s| %-15s| %-10s", "Account #", "username_of_account_holder",
		...
		for (int i = 0; i < accounts.size(); i++) {
			...
			System.out.println(String.format("%-10s| %-30s| %-10s| %-15s| $%-10.2f", account.getAccount_number(),
					account.getUsername_of_account_holder(), account.getAccount_type(),
					new SimpleDateFormat("dd/MM/yyyy").format(account.getAccount_opening_date()), balance));
		}
		System.out.println();
	}
